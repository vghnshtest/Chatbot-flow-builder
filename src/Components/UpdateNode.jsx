...
const UpdateNode = ({
  ...
  return (
    ...
    <>
      ...
      <div style={{ width: `100%`, height: 2, background: '#F3F3F3' }}></div>

      <div className="update">
        <h3 style={{color:'gray', fontWeight:'500'}}>Text:</h3>
        <textarea
          rows="4"
          cols="25"
          value={nodeName}
          ...
          style={{ marginBottom: 15, borderRadius: 5 , background:'white', color:'darkslategray'}}
        />
      </div>
      <div style={{ width: `100%`, height: 2, background: 'grey' }}></div>
    </>
